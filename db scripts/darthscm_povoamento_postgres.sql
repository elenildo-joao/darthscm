...
-- --------------------------------------------------------
INSERT INTO Enderecos VALUES (DEFAULT, 'Av. Am�lia Amado', 1, 'Centro', 'Itabuna', 'BA', 'Rua do canal');
INSERT INTO Enderecos VALUES (DEFAULT, 'Av. Princesa Isabel', 1, 'S�o Caetano', 'Itabuna', 'BA', NULL);
INSERT INTO Enderecos VALUES (DEFAULT, 'Rua S�o Jo�o', 1, 'F�tima', 'Itabuna', 'BA', 'pr�ximo � lot�rica');
INSERT INTO Enderecos VALUES (DEFAULT, 'Rua Uni�o Oper�ria', 1, 'Pontalzinho', 'Itabuna', 'BA', NULL);
INSERT INTO Enderecos VALUES (DEFAULT, 'Av. Juracy Magalh�es', 1, 'Centro', 'Itabuna', 'BA', NULL);
INSERT INTO Enderecos VALUES (DEFAULT, 'Rua Local G', 1, 'Nelson Costa', 'Ilh�us', 'BA', NULL);
INSERT INTO Enderecos VALUES (DEFAULT, 'Rua It�lia', 1, 'Pontal', 'Ilh�us', 'BA', NULL);
INSERT INTO Enderecos VALUES (DEFAULT, 'Rua Mac�rio dos Reis', 1, 'Santo Ant�nio', 'Itabuna', 'BA', 'pr�ximo ao hospital');
...
INSERT INTO Usuarios VALUES (DEFAULT, 'Cl�cia Santos', 'clicia@gmail.com', '00100100101', '1990/01/01', '7399010001', 2, FALSE, 'F');
...
INSERT INTO Mensagens VALUES (DEFAULT, 3, 'Problema na tarefa (RE)', 'Tr�s na minha sala', '2012/03/30 11:00:24', false, false);
INSERT INTO Mensagens VALUES (DEFAULT, 1, 'Not�cias', 'Como est�o as atividades?', '2012/04/04 08:00:00', false, true);
INSERT INTO Mensagens VALUES (DEFAULT, 5, 'Not�cias (RE)', 'Tudo bem. Estou desenvolvendo os requisitos do sistema', '2012/04/04 09:00:32', false, true);
INSERT INTO Mensagens VALUES (DEFAULT, 8, 'Sugest�o', 'Eu acho que deveria haver a tabela de deprecia��es na estimativa de custo', '2012/03/30 15:04:08', false, false);
INSERT INTO Mensagens VALUES (DEFAULT, 1, 'Documento de vis�es', 'O documento de vis�es ficou �timo!', '2012/04/02 14:06:54', false, true);
INSERT INTO Mensagens VALUES (DEFAULT, 4, 'Ajuda', 'Tenho pouca experi�ncia com plano de qualidade, algu�m pode me ajudar com algum material?', '2012/03/28 10:10:10', false, false);
...
INSERT INTO Tarefas VALUES (DEFAULT, 1, 'Arquitetura de software', 'Mostrar detalhadamente a arquitetura em várias visões.', '2012/04/01', '2012/05/29', NULL, 'normal', NULL, NULL);
...
-- (id, idtarefas, idprojeto, descri��o, datadetec��o, datasolucao, gravidade, usuariodetecta, usuariosoluciona, tree, sha1, idrepositorio)
-- ---------------------------------------------------------
INSERT INTO Bugs VALUES (DEFAULT, 28, 1, 'O documento de requisitos requer mudan�a na numera��o do documento', '2012/05/02', '2012/05/28', 'normal', 1, 6, 'requisitos_do_software', 'chave_crip', 1);
INSERT INTO Bugs VALUES (DEFAULT, 29, 1, 'O documento de vis�o tem tabelas incompletas', '2012/05/02', NULL, 'normal', 1, NULL, 'documento_de_vis�o', 'chave_crip', 1);
INSERT INTO Bugs VALUES (DEFAULT, NULL, NULL, 'O banco de dados nao detecta quais tarefas est�o fechadas', '2012/05/29', NULL, 'alta', 8, NULL, 'modelagem_banco_de_dados', 'chave_crip', 1);
INSERT INTO Bugs VALUES (DEFAULT, 30, 2, 'Bug na proposta ao cliente, o or�amento informado nao vale mais para a data presente', '2012/05/29', '2012/06/03', 'alta', 2, 3, 'proposta_ao_cliente', 'chave_crip', 2);
INSERT INTO Bugs VALUES (DEFAULT, NULL, NULL, 'Erro no banco de dados, a tabela usuario tem um atributo para endere�o. Deveria ser uma tabela.', '2012/05/30', NULL, 'maxima', 2, NULL, 'modelagem_banco_de_dados', 'chave_crip', 1);
...
INSERT INTO SolicitacoesMudanca VALUES (DEFAULT, 'Quero mudar a proposta do cliente, pois se faz necess�rio acrescentar o t�pico contatos da empresa', '2012/05/04', 'aprovado', 2, 1, 8, 1, 6);
...
-- (id, tree, sha1, datahora, solicitacaoMudan�a, idrepositorio)
-- ---------------------------------------------------------
...
-- (id, idmudan�a, idauditor, estado, datahora)
-- ---------------------------------------------------------
